...
const HeroSection = () => {
    return (
        <div className="flex flex-col items-center mt-6 lg:mt-20">
            ...
            <p className='mt-10 text-lg text-center text-neutral-500 max-w-4xl'>Empower your creativity and bring your VR app ideas to life with our intuitive developmemt tools.Get started today and turn your imagination into immersive reality.!</p>
            ...
            <div className='flex mt-10 justify-center'>
                <video autoPlay loop muted className='rounded-lg w-1/2 border-orange-400 shadow-orange-400 mx-2 my-4' >
